...
## 2. Customer segmentation — NOT STARTED
- Blocked by: needs real sales history (from #1) to have anything to segment
- Do not start until #1 has real usage data, even simulated
