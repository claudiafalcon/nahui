...
**Status:** substantively closed pending the small `981:620` content fix (dispatched, not yet folded in as of this entry) and the standing next step — a fresh, isolated `merchant-user-tester` rerun of the full Paid journey from the beginning.
