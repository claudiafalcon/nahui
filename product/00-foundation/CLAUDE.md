...
- Building in `02-build`? Read `domain-model.md` and `architecture-principles.md` first. Aggregate boundaries and dependency directions here are load-bearing, not suggestions — check `decision-log.md` before changing one.
