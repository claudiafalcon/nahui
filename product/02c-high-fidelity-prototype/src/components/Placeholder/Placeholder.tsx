...
export function Placeholder({
  ...
  return (
    <div className={styles.wrap}>
      ...
      <p className={styles.body}>Esta sección no está incluida en este prototipo — la vista completa cubre Hoy, Inventario, registrar mercancía, vender, el recibo y Eventos.</p>
      {onBack && (
