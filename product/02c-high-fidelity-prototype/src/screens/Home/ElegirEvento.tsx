 ...
 * remediation (ux-critic MAJOR-1). **The former §3.6a mention this stack
 * used to end on (`NfcSessionStartNote`) is retired outright,
    ...
    <>
      ...
      <div className={styles.wrap}>
        ...
        <div className={styles.secondaryActionGroup}>
          <Button variant="secondary" onClick={onStartQuickSession}>
