...
- **[`docs/passes/slice-2-authentication-onboarding.md`](docs/passes/slice-2-authentication-onboarding.md)** — Phone → OTP → Owner identity → Business onboarding, per RFC 0007/D44 and `decision-log.md` D42/D43/D45.
