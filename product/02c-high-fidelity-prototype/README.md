...
see "Eventos pass" below. Configuración (the four Business Capability
actions plus the account-level "Cerrar sesión") was added 2026-08-13 per
`product/02-ux/settings.md` (Approved) — see "Configuración pass" below.
