...
**Status: Proposals drafted by `ui-designer`, evaluating the live running prototype end-to-end. Nothing built yet. Product Owner has directed all 6 to be implemented — see build status per item below as each is dispatched.**
...
- **Build status:** not yet dispatched.
